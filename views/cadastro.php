        ...
        <div class="auth-container">
            <div class="auth-card">
                ...
                <div class="auth-header-texto">
                    <h2 class="auth-título" >Crie sua conta</h2>
                    <p class="auth-subtítulo" id="authSubtitle">Comece a organizar suas tarefas gratuitamente</p>
                </div>
                ...
                <form
                    ...
                    action="../controllers/auth_controller.php?acao=cadastro"
                    method="POST"
                >
                    <!-- Nome -->
                    ...
                    <div class="form-grupo">
                        ...
                        <div class="input-w">
                            ...
                            <input 
                                ...
                                required
                            />
                            <button type="button" class="esconder-senha" data-target="registerPassword">
